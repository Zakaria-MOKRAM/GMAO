...
@AllArgsConstructor
@NoArgsConstructor
public class Fournisseur_Service implements Serializable {
    ...
    private int client;
    @ManyToMany
    @JoinTable(name = "jw_categorie_fournisseur_service", joinColumns = @JoinColumn(name = "fk_soc"), inverseJoinColumns = @JoinColumn(name = "fk_categorie"))
